/* ══════════════════════════════════════════
   RAKURAKU 求人自動入力 — バイトル content script
   ══════════════════════════════════════════ */
...
(function() {
  async function main() {
    ...
    if (!looksLikePostingPage()) {
      showBanner('バイトル', '求人作成ページに移動してから内容を確認してください。', true);
      return;
    }
    fillForm(pending);
    showBanner('バイトル', '求人内容を自動入力しました。確認して公開してください。', false);
  }
  ...
  main().catch(e => console.error('[RAKURAKU バイトル]', e));
})();
