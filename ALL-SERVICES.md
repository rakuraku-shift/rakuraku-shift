...
| # | URL | 役割 | 状態 |
|---|---|---|---|
| (+) | `/bar.html` | バー業界専用 LP (HUB/キャストバー特化) | ✅ |
| (+) | `/izakaya.html` | 居酒屋業態専用 LP (大型店/チェーン対応) | ✅ |
| (+) | `/cafe.html` | カフェ業態専用 LP (早朝/留学生対応) | ✅ |
| (+) | `/pricing-simulator.html` | 料金シミュレーター (年間節約額計算) | ✅ |
...
| # | URL | 役割 | 状態 |
|---|---|---|---|
| 34 | `/404.html` | 404エラーページ (検索バー+ナビ4カード付き) | ✅ |
| 35 | `/500.html` | 500サーバーエラーページ (再読込・稼働状況リンク) | ✅ |
| 36 | `/503.html` | 503メンテナンスページ (60秒自動再読込) | ✅ |
